"""
Парсер для Melbet (melbet.ru)
API: https://melbet.ru/api
...
class MelbetParser:
    def __init__(self):
        self.base_url = "https://melbet.ru/api"
    ...
    def get_sports(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"[Melbet] Ошибка получения sports: {e}")
        return []
    ...
    def get_events(self, sport_id: Optional[int] = None, live: bool = False) -> List[Dict]:
        ...
        try:
            ...
            print(f"[Melbet] Ошибка получения events: {e}")
        return []
    ...
    def run(self, interval: int = 10, max_iterations: int = 0):
        ...
        iteration = 0
        print(f"[Melbet] Запуск парсера (интервал: {interval}с)")
        ...
        try:
            ...
            print("\n[Melbet] Остановка парсера")
        except Exception as e:
            print(f"[Melbet] Критическая ошибка: {e}")


if __name__ == "__main__":
    parser = MelbetParser()
    
    print("=== Тест Melbet Parser ===\n")
